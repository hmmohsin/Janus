...
EXAMPLE_DIRECTORIES = ['mac', 'matrix-topology', 'socket', 'stats', 'PowerTCP', 'tutorial', 'ABM', 'udp', 'realtime', 'ipv6', 'tcp', 'routing', 'udp-client-server', 'error-model', 'traffic-control', 'channel-models', 'wireless', 'naming', 'energy']
...
NS3_EXECUTABLE_PATH = ['/mnt/extra/ns3-datacenter/simulator/ns-3.35/build/src/fd-net-device', '/mnt/extra/ns3-datacenter/simulator/ns-3.35/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/11', '/mnt/extra/ns3-datacenter/simulator/ns-3.35/build/lib', '/mnt/extra/ns3-datacenter/simulator/ns-3.35/build']
...
cfg_files = ['/mnt/extra/ns3-datacenter/simulator/ns-3.35/build/ns3/config-store-config.h', '/mnt/extra/ns3-datacenter/simulator/ns-3.35/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
